...
export default function Insight({ lng }) {
  ...
  return (
    <>
      ...
      <div className={styles.cards}>
        <div className={styles.card} onClick={handleClickRequest}>
        ...
        <div
          ...
          onClick={() => handleClickCopy("metabase")}
        >
        ...
        <div className={styles.card} onClick={() => handleClickCopy("powerbi")}>
          <div className={styles.top}>
            <img
              alt={t("powerbi")}
        ...
        <div className={styles.card} onClick={() => handleClickCopy("tableau")}>
          <div className={styles.top}>
            <img
              alt={t("tableau")}
        ...
        <div className={styles.card} onClick={() => handleClickCopy("looker")}>
          <div className={styles.top}>
            <img
              alt={t("looker")}
      ...
      {toggle && (
        <>
          <div className={styles.modal}>
            <button className={styles.closemodal} onClick={handleClickClose}>
              &times;
            </button>
            <h2>📋 {t("copied")} </h2>
            <p> {t("text")}</p>
