...
let rawDestinationSchema = fs.readFileSync("./../jsonschema/destination-api.schema.json");
...
fs.writeFileSync('./generated/sample-insights-destination-output.json', stringified);
