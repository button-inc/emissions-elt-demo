...
create table data_clean_room.track_format(
  id SERIAL PRIMARY KEY,
  nickname TEXT not null
);

create table data_clean_room.import_record(
  job_id SERIAL PRIMARY KEY,
  file_name TEXT not null,
  uploaded_by_user_id INTEGER REFERENCES data_clean_room.permissions(id),
